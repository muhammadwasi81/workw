...
//       this.props.onChange({value:this.state.value,name:actionMeta.name})
//     });
//   };
...
//       return state.data.isFixed ? { ...base, display: "none" } : {...base,backgroundColor:"rgb(26, 86, 105)", color:"white"};
//     },
//     multiValueLabel: (base, state) => {
//       return state.data.isFixed
//         ? { ...base,backgroundColor:"rgb(26, 86, 105)", fontWeight: "bold", color: "white", paddingRight: 6 }
//         : {...base,backgroundColor:"rgb(26, 86, 105)", color:"white"};
//     },
...
//       !findVal && this.setState({ value: [...this.state.value,{label:this.props.value}] }
//         // console.log(this.state.value, "VALUE");
//       );
//     }
...
//               }}
//             >
//               Loading <Spin indicator={antIcon} style={{ marginLeft: "5px" }} />
//             </div>
//           )}
//         </components.Menu>
//       </Fragment>
...
//     return (
//       this.state.custom?(<CreatableSelect
...
//         components={{ Option: this.options, Menu: this.menu ,DropdownIndicator:() => null, IndicatorSeparator:() => null}}
