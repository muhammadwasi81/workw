        ...
        <div className="commentComposer">
            <div className="img">
                <Avatar src={"https://konnect.im/upload/2021/3/5325454b-1c5d-40f1-b95d-df0fad2d4da9.jpeg"}
                    name={"Aqib Memon"} width={33} height={33}
                    round={true} />
            </div>
            {/* onCommentSend({comment:state.commentText, attachmentFile : state.attachmentFile}) */}
            <div className="composer-area">
                <form className="inputs" onSubmit={(e)=>{e.preventDefault(); console.log("fff")}}>
                    <div className="inp">
                        <textarea
                    ...
                    {  isAttachment &&
                        <div className="capture">
                            <input accept=".jpg, .jpeg, .gif, .bmp, .png, .mp4" type="file" onChange={handleCommentImageChange} />
                        </div>
                    }
