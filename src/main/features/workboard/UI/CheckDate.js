        ...
        <div
          className={`group w-fit hover:bg-neutral-200 rounded-sm ${
            checked
              ...
              : dateVal === "yesterday" || (dDiff && dateVal !== "today")
        ...
        >
          <div className="group-hover:hidden flex items-center gap-2 leading-[1.4rem]">
            ...
            <span className="pr-[8px]">
              {moment(new Date(dueDate), "DD/MM/YYYY").format("D MMM")}
            </span>
          </div>
          ...
          <div className={`hidden group-hover:block leading-[1.4rem] `}>
            <Checkbox
              onChange={onChange}
              checked={checked}
              className={`text-base !pr-0 ${checked && `!text-white`}`}
            >
              <span
        ...
        <div className="flex gap-2 items-center">
          ...
          >
            ...
            {checked ? (
              ...
              dateVal === "today" && <Tag color="#F2D600">due soon</Tag>
            )}
            <DownOutlined />
          </div>
        </div>
