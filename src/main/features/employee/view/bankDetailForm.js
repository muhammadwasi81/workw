                ...
                {fields.map(({ key, name, ...restField }, i) => (
                  ...
                  >
                    <S.EFormItem
                      ...
                      direction={Direction}
                    >
                      <Input placeholder={placeholder.bankName} size="large" />
                    </S.EFormItem>
                    {/* <S.CustomSelect
													showSearch
                    ...
                    <S.EFormItem
                      ...
                      direction={Direction}
                    >
                      <Input size="large" placeholder={placeholder.accTitle} />
                    </S.EFormItem>
                    <S.EFormItem
                      rules={[{ required: true }]}
                    ...
                    <S.EFormItem
                      ...
                      direction={Direction}
                    >
                      <Input size="large" placeholder={placeholder.accNo} />
                    </S.EFormItem>
                    <S.EFormItem
                      rules={[{ required: true }]}
                      label={value.IBAN}
                      ...
                      direction={Direction}
                    >
                      <Input size="large" placeholder={placeholder.iban} />
                    </S.EFormItem>
                    <S.EFormItem
                      rules={[{ required: true }]}
                      ...
                      direction={Direction}
                    >
                      <Input size="large" placeholder={placeholder.sortCode} />
                    </S.EFormItem>
