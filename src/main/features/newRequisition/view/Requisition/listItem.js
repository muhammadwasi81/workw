    ...
    {/* <ContBody>
      ...
      <div className="left">
            ...
            <div className="left-container">
               <Button type="primary" className="approve-btn">Approvers</Button>
               <Button type="primary" className="copy-btn">Copy Link</Button>
               <Button type="primary" className="copy-btn"> Link</Button>
            </div>
          </div>
