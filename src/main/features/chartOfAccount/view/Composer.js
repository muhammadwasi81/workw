...
function Composer() {
    ...
    const { listData, editData } = useSelector(state => state.chartOfAccountsSlice);

    const accountTypes = [{ accountType: 1, label: "Asset" }, { accountType: 2, label: "Liability" }, { accountType: 3, label: "Capital" }, { accountType: 4, label: "Revenue" }, { accountType: 5, label: "Expense" }, { accountType: 6, label: "Cost of Good Sold" }]
