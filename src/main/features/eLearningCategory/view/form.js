...
export default function ELearningCategoryForm({
	...
	return (
		<FormContainer>
			<FormHeader>{administration.elearningCategory.elearningCategory}</FormHeader>
			<FormInputContainer>
				<FormInput>
					<FormLabel>{administration.elearningCategory.elearningCategory}</FormLabel>
					<Input
						placeholder={administration.elearningCategory.enterelearningCategory}
						value={form.name}
