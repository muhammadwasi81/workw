    ...
    <div className="gap-5 flex flex-col 2xl:flex-row  ">
      <section className="flex flex-col gap-3 basis-7/12">
        ...
        >
          ...
          <Form.Item
            name="address"
            label={<span className="text-primary-color">{detail.address}</span>}
          >
            <Input
          ...
          <Form.Item
            name="website"
            label={<span className="text-primary-color">{detail.website}</span>}
          >
            <Input
                  ...
                  data?.contacts.map((contact) => (
                    ...
                    >
                      <div className="flex items-center justify-between w-full">
                        ...
                        <Tag
                          color={contact.activeStatusId === 1 ? `green` : `red`}
                        >
