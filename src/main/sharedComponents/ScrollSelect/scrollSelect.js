    ...
    <div className="ant-col ant-form-item-control">
      <div className="ant-form-item-control-input">
        ...
        >
          ...
          >
            <div className={`${mainClass}_input_container ant-select-selector`}>
              ...
              <span
                className={`ant-select-selection-placeholder ${input.length >
                  0 && 'placeholder_hidden'}`}
              >
                Search to Select
              </span>
              {!iconChangeOnClick ? (
                ...
                <SearchOutlined className={`${mainClass}_icon`} />
              )}
            </div>
