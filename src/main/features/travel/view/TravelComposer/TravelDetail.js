    ...
    <TravelCard>
      <S.FormItem direction={Direction}>
        <div className="input-row">
          ...
          />
          {errors.reason && (
            <div style={{ color: "red" }}>Please enter valid reason.</div>
          )}
        </div>
      </S.FormItem>
      <div className="input-row">
      ...
      <div className="input-row">
        ...
        <div className={`${isTablet ? "flex wrap gap-10" : "travel_date"}`}>
          <DatePicker
          ...
          {isReturn && (
            ...
            <DatePicker
              ...
              value={
                state.returnDate !== "" ? moment(state.returnDate) : moment()
              }
      ...
      <div className={`travel_tags_flex ${isTablet && "wrap "}`}>
        <div
          className={
            "travel-type " + `${isTablet && "wrap justify-evenly w-full"}`
          }
        >
  ...
  return (
    <div
      className={`expense-tag tag_relate ${
        String(selected) === String(itemId) ? "expense_tag_selected" : ""
      }`}
      tabIndex={0}
    >
