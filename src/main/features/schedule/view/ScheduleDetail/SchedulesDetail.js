	...
	const panes = [
		{
			featureName: "Past",
			featureId: 0,
			content: <ScheduleCard sheduleType="Past" setType={setType} />,
		},
		{
			featureName: "Today",
			featureId: 1,
			content: <ScheduleCard sheduleType="Today" setType={setType} />,
		},
		{
			featureName: "Upcoming",
			featureId: 2,
			content: <ScheduleCard sheduleType="Upcoming" setType={setType} />,
		},
	];
							...
							<div className="eventDetail__body">
								...
								<div className="eventDetail__body-description">
									...
									<span>
										...
										adipisicing elit. Sequi eos quaerat
										iusto, expedita ut veritatis alias illum
										quis dignissimos, saepe omnis. Autem,
