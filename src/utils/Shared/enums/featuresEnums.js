...
export const FeaturesEnumList = [
  { label: "Feed", value: FeaturesEnum.Feed },
  ...
  { label: "Task", value: FeaturesEnum.Task },
  { label: "Workboard", value: FeaturesEnum.Workboard },
  { label: "Lead", value: FeaturesEnum.Lead },
  { label: "Expense", value: FeaturesEnum.Expense },
  { label: "Schedule", value: FeaturesEnum.Schedule },
  { label: "Travel", value: FeaturesEnum.Travel },
  { label: "Document", value: FeaturesEnum.Document },
