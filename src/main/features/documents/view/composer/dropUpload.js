...
const UploadByDrop = ({ isOpen, handleClose, fileList }) => {
  ...
  return (
    <>
      <Modal
        title={documentDictionary.UploadDocuments}
        centered
        visible={visible}
        // onOk={() => setVisible(false)}
        onCancel={handleClose}
        width={1000}
        okText={documentDictionary.Upload}
      >
        <div
              ...
              >
                ...
                >
                    ...
                    <div style={{ display: "flex", marginLeft: 18 }}>
                      <div
                        style={{
                          ...
                          cursor: "pointer",
                          backgroundColor:
                            item.isPublic === 1 ? "#abecf373" : "white",
                        }}
                        //  onClick={() => onChangePrivacy(1, ind)}
                      >
                        {documentDictionary.Public}
                        {/* <PublicSharpIcon fontSize="small"/> */}
                      </div>
                      <div
                        style={{
                          backgroundColor:
                            item.isPublic === 2 ? "#ffa5a573" : "white",
                          padding: "2px 8px",
                          borderRadius: "6px",
                          fontSize: "14px",
                          fontWeight: "900",
                  ...
                  >
                    ...
                    >
                      {documentDictionary.Description}:
                    </div>
                    <input
                      style={{
                        border: "1px solid #e7e7e7",
                  ...
                  >
                    ...
                    >
                      {documentDictionary.selectApprovals}:
                    </div>
                  ...
                  {item.isPublic === 2 && (
                    ...
                    >
                      ...
                      >
                        {documentDictionary.selectReaders}:
                      </div>
                      <div style={{ display: "flex", width: "80%" }}>
                        {/* <SearchableInput
                                        label={false}
        ...
        <SingleUpload
          ...
          img="Add Image"
          position="flex-start"
          uploadText={documentDictionary.Upload}
