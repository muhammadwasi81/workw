...
const AdminRoutes = () => {
  return (
    <Routes>
      ...
      <Route path={ROUTES.ADMINISTRATOR.OFFICETIME} element={<OfficeTiming />} />
      <Route path={ROUTES.ADMINISTRATOR.LEAVE_TYPES} element={<LeaveType />} />
      {/* <Route path={ROUTES.ADMINISTRATOR.USER_TYPES} element={} />  */}
      <Route path={ROUTES.ADMINISTRATOR.EXPENSE_HEADERS} element={<ExpenseHeader />} />
      <Route path={ROUTES.ADMINISTRATOR.SALARY_HEADERS} element={<SalaryHeader />} />
      <Route path={ROUTES.ADMINISTRATOR.EMAIL_CONFIG} element={<EmailConfiguration />} />
      {/* <Route path={ROUTES.ADMINISTRATOR.REQUEST_FOR_RIGHTS} element={} /> */}
      <Route path={ROUTES.ADMINISTRATOR.CUSTOM_APPROVAL_CATEGORY} element={<CustomApprovalCategory />} />
      <Route path={ROUTES.ADMINISTRATOR.ALLOWANCES} element={<Allowance />} />
      <Route path={ROUTES.ADMINISTRATOR.JOB_SKILLS} element={<JobDescription />} />
      <Route path={ROUTES.ADMINISTRATOR.REWARD_CATEGORY} element={<RewardCategory />} />
      <Route path={ROUTES.ADMINISTRATOR.WARNING_CATEGORY} element={<WargningCategory />} />
    </Routes>
  );
};
