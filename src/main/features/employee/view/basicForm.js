...
const BasicInfo = ({ mode, id }) => {
  ...
  const [newAccessRoles, setNewAccessRoles] = useState([]);
  const initialState = {
    coverImageId: '',
  ...
  return (
    <div className={classes}>
      ...
      >
        ...
        >
          <SingleUpload
            url={isEdit ? initialValues.image : STRINGS.DEFAULTS.guid}
            value={profileImage}
