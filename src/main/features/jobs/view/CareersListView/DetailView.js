      ...
      <div className="item-card careersQuickDetail" >
        ...
        <div className="careersShortCard cursor-pointer !flex !flex-row gap-2" >
          ...
          <div className="flex-1" >
            ...
            <div className="text-xs">Karachi, Pakistan - {moment("09-22-2022").fromNow()}</div>
          </div>
        ...
        <div className="mt-5">
          ...
          <div>
            ...
            as well as coordinating with the teams responsible for other layers of the product infrastructure.
            well as coordinating with the teams responsible for other layers of the product infrastructure. Building
            a product is a highly collaborative effort, and as such,
            a strong team player with a commitment to perfection is required.
          </div>
        </div>
        ...
        <div className="cardSections mt-10">
          ...
          <div className="cardSectionItem">
            ...
            <div className="cardSection__body">{moment("09-22-2022").format("Do MMM YY")}</div>
          </div>
          <div className="cardSectionItem">
