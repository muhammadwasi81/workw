    ...
    <div className="gap-5 flex flex-col z-10 ">
                ...
                <div className="flex justify-between flex-wrap mt-2">
                  ...
                  <div>
                    <Attachments
                      ...
                      key={data}
                      onClick={() => {
                        dispatch(handleAttachmentModal(data.attachments));
                      }}
                    />
                  </div>
                </div>
                <div className="flex  min-w-fit border-r-2 gap-3 bg-[#F6F7F9] p-2 rounded flex-wrap items-center relative overflow-x-auto ">
                  <div className="flex gap-3 items-center min-w-[200px]">
                    <img src={Calender} alt="" className="h-[30px]" />
                    <div className="flex flex-col gap font-semibold">
                      <span className="">{headings.departureDate}</span>
                      <span className="text-primary-color">
                        {moment(data.cities[0].departureDate).format(
                          "D MMM YYYY"
                        )}
                      </span>
                    </div>
                  ...
                  <div className="flex gap-3 items-center min-w-[200px]">
                    ...
                    <div className="flex flex-col gap font-semibold">
                      <span className="">{headings.departureTime}</span>
                      <span className="text-primary-color">
                        {moment
                          .utc(data.cities[0].departureDate)
                          .local()
                          .format("HH:mm")}
                      </span>
                    </div>
                  ...
                  <div className="flex gap-3 items-center before:h-[40px] before:-left-[50px] before:w-[1px] before:bg-[#D9D9D9] before:absolute relative min-w-[300px]">
                    ...
                    <div className="flex flex-col gap font-semibold">
                      ...
                      <span className="text-primary-color">
                        {data.departure + " - " + data.departureCountry}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 items-center before:h-[40px] before:-left-[50px] before:w-[1px] before:bg-[#D9D9D9] before:absolute relative min-w-[300px]">
                    ...
                    <div className="flex flex-col gap font-semibold">
                      ...
                      <span className="text-primary-color">
                        {data.arrival + " - " + data.arrivalCountry}
                      </span>
                    </div>
                  </div>
                  <div className="flex gap-3 items-center before:h-[40px] before:-left-[50px] before:w-[1px] before:bg-[#D9D9D9] before:absolute relative min-w-[200px]">
                    <div className="flex flex-col gap font-semibold">
      ...
      >
        <CustomModal
          ...
          children={<AttachmentsCarrousel attachments={data} key={data} />}
        />
      </div>
    </div>
  );
