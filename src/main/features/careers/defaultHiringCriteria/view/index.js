...
import { addDefaultHiringCriteria, getAllDefaultHiringCriteria, removeDefaultHiringCriteria, updateDefaultHiringCriteria} from "../store/actions";
import Form from "./form.js";
import TableView from "./table.js";

export default function DefaultHiringCriteria() {
  const initialState = { question: "" };
  const [defaultHiringCriteria, setDefaultHiringCriteria] = useState(initialState);
  ...
  return (
    <AdminContainer>
      <Form clearButton={clearButton} setClearButton={setClearButton} data={defaultHiringCriteria} onSubmit={onSubmit} />
      <TableView
