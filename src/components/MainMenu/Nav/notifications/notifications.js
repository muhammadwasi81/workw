                ...
                <div className="toggle-panel">
                    <div className="toggle-board">
                        <div className="board-header">
                            ...
                            <div className="board-setting" onClick={this.readAllNotifications}><span>Read All</span>
                            </div>
                        </div>
                        <div ref={this.notificationsHolder} className="board-body ov-des">
                            {
                                ...
                                notifications.map(notification => {
                                    const {
                                        notification_id, datetime, username,
                                        profile_picture, message, is_read,
                                        //ref_id, type,
                                    } = notification;
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="detail">
                                                <div className="text">
                                                    <NavLink to="#">{username}</NavLink>{message}
                                                </div>
                            ...
                            {loading && <div className="note"><Spin size="small" /></div>}
                        </div>
                    </div>
                </div>
            </div>
