...
function AccessRoleComposer(props) {
  ...
  // function getCheckedPermissionIds(featuresTreeData) {
  //   let checkedPermissionIds = [];
  //   for (let i = 0; i < featuresTreeData?.length; i++) {
  //     let feature = featuresTreeData[i];
  //     console.log(feature, 'feature');
  //     let permissionId = feature.children?.map((x) => x?.permissionId);
  ...
  //   featuresTreeData
  // );
  // console.log(checkedPermissionIds, 'checkedPermissionIds');
