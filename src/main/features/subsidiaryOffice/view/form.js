...
export default function Form({
  ...
  return (
    <FormContainer>
      <FormHeader>
        {administration.subsidiaryOffice.subsidiary_Office}
      </FormHeader>
      <FormInputContainer>
        <FormInput>
        ...
        <FormInput>
          ...
          <Input
            value={form.lng}
            onChange={handelChangeLongitude}
            type={"number"}
          />
        </FormInput>
      </FormInputContainer>
