...
function ProfilePanelList() {
	...
	return (
		<div className="flex flex-col bg-white basis-[300px]">
			{listItem.map(list => {
				return (
					<div className="p-2 ">
						<NavLink
							...
							className={({ isActive }) =>
								isActive
									...
									: "text-gray-500 p-2 text-base hover:!bg-[#526bb13d] hover:!text-primary-color rounded-[8px] flex transition-all duration-300"
							}
						>
							{list.name}
						</NavLink>
