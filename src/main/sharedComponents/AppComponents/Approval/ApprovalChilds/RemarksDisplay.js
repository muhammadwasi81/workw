  ...
  return (
    ...
    <div className="remarks-display">
      <div className="remarks-header">
        ...
        <div className="remarks-header-right"><MoreOutlined /></div>
      </div>

      <p className="remarks-content">
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi hic,
        nisi magnam impedit autem accusamus maxime libero odio reprehenderit
        vero iste nesciunt fuga perferendis nobis sed magni quis nam saepe.
      </p>
    </div>
