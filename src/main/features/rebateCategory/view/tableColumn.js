...
export const tableColumn = (
  ...
  return [
    ...
    { title: "Max Amount", dataIndex: "maxAmount", width: "20%", key: 3 },
    { title:  
      "Rebate Type",
      dataIndex: "rebateType",
      width: "15%",
      render: (text, row) => {
        return text === RebateTypeEnum.Basic ?  Basic : text === RebateTypeEnum.Tax ?  Tax : text === RebateTypeEnum.FullAmount ?  FullAmount : ""
      }
