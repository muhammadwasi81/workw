		...
		<span className="spinner-holder">
			...
			>
				...
				<circle
					...
					r="3.7"
					fill={`${
						props.props !== undefined ? props.props : "#fffbf2"
					}`}
				/>
				<circle
					cx="5.02"
					...
					r="3.4"
					fill={`${
						props.props !== undefined ? props.props : "#fef7e4"
					}`}
				/>
				<circle
					cx="5.02"
					...
					r="3.1"
					fill={`${
						props.props !== undefined ? props.props : "#fef3d7"
					}`}
				/>
				<circle
					cx="12.19"
					...
					r="2.8"
					fill={`${
						props.props !== undefined ? props.props : "#feefc9"
					}`}
				/>
				<circle
					cx="24"
					...
					r="2.5"
					fill={`${
						props.props !== undefined ? props.props : "#feebbc"
					}`}
				/>
				<circle
					cx="35.81"
					...
					r="2.2"
					fill={`${
						props.props !== undefined ? props.props : "#fde7af"
					}`}
				/>
				<circle
					cx="42.98"
					...
					r="1.9"
					fill={`${
						props.props !== undefined ? props.props : "#fde3a1"
					}`}
				/>
				<circle
					cx="42.98"
					...
					r="1.6"
					fill={`${
						props.props !== undefined ? props.props : "#fddf94"
					}`}
				/>
				<circle
					cx="35.81"
					...
					r="1.3"
					fill={`${
						props.props !== undefined ? props.props : "#fcdb86"
					}`}
				/>
			</svg>
		</span>
...
export function getTypeOfFile(fileName) {
	...
	else if (STRINGS.VIDEO.includes(ext))
		return STRINGS.TYPES.ATTACHMENTS.VIDEO;
...
export function setUpMentionsView(inp, selectedList, users, submit = null) {
	...
	inp.on("mouseup keydown", function(e) {
		if (e.key === "@") {
			...
			if (
				inp.offset().top + inp.outerHeight() + 22 >=
				$(window).height()
			) {
