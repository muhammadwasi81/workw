...
import QuestionList from "../appraisalModule/view/components/TeamAppraisal/questionList";
import TaskList from "../appraisalModule/view/components/TeamAppraisal/TaskList";
  ...
  return (
    <>
      ...
      <SingleItem
        ...
        style={{ boxShadow: "0px 0px 2px 1px rgb(0 0 0 / 20%)" }}
      >
        <CardProfileTopView
          profileImgSrc={
            <AvatarCustom
