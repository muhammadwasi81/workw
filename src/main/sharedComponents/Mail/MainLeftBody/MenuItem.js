...
const MenuItem = ({
	...
	const setDefaultIcon = labelName => {
		if (labelName === "Testing" || labelName === "Notes") {
			return <MdLabel size={20} color={"#1A5669"} />;
		} else if (labelName === "spam") {
			return <RiSpamFill size={20} color={"#1A5669"} />;
		} else if (labelName === "Trash") {
			return <MdDelete size={20} color={"#1A5669"} />;
		} else if (labelName === "Sent") {
			return <MdSend size={20} color={"#1A5669"} />;
		} else if (labelName === "Drafts") {
			return <MdDrafts size={20} color={"#1A5669"} />;
		} else if (labelName === "Archive") {
			return <MdArchive size={20} color={"#1A5669"} />;
		} else return <MdLabel size={20} color={"#1A5669"} />;
	};
