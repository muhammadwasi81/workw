...
//                     setSelectedAttachments(selectedAttachments.concat(response.data))
//                     setLoaderViews([])
...
//         setSelectedAttachments(selectedAttachments.filter((d, index) => index !== i))
//     }
...
//             {isEmptyField && (<div className={classes.errorMessage}>{isEmptyField}</div>)}
...
//                             <div className="localImgCont"
//                                  style={{
//                                      height: (selectedAttachments.length !== 0 || loaderViews.length !== 0) ? "70px" : "min-content",
//                                      padding: "0"
//                                  }}
//                             >
//                                 {
//                                     selectedAttachments.map(({extensionType, path, attachmentName}, i) => (

//                                         <div key={`bottomChatAttachmentImage${i}`} className="imageDiv" style={{
...
//                                 <div className="capture extraMargin"
//                                      onChange={handleImageChange}>
//                                     <i className="ic-gallery"/>
//                                     <input className="picker picture"
//                                            type="file"
//                                            name="pictures"
