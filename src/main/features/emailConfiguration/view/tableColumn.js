...
export const tableColumn = (
  ...
  return [
    ...
    { title: "Incoming Port", dataIndex: "incomingPort", width: "10%" },
    { title: "Incoming ServerAddress", dataIndex: "incomingServerAddress", width: "15%" },
    { title: "Outgoing Port", dataIndex: "outgoingPort", width: "10%" },
    { title: "Outgoing Server Address", dataIndex: "outgoingServerAddress", width: "20%" },
