...
import ApproverListItem from "../../../../sharedComponents/AppComponents/Approvals/components/approverList";import { addBookMember, 
    getAllBookMember,getAllLeadManagerMember,addLeadManagereMember
 } from "../../store/actions";
...
function MemberModal({ isOpen = false }) {
    ...
    const modalRequest = useSelector(state => state.leadMangerSlice.addMemberModal);
    const { courseMembers, bookMembers } = useSelector((state) => state.leadMangerSlice)
